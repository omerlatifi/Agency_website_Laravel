...
<section class="admission-banner">
  <div class="container admission-inner">
    ...
    <div class="admission-text">
      ...
      <h1>Find Affordable and Trusted Student Accommodations</h1>
    ...
    <div class="admission-image">
      <img src="{{ asset('images/accomdation4.jpg') }}" alt="Admission Support" />
    </div>
...
<section class="accommodation">
  <div class="container">
    <h2 class="accommodation-title">Choose from Reliable Accommodation Providers</h2>

    <div class="accommodation-grid">

      <!-- Card 1 -->
      <div class="accommodation-card">
        <img src="{{ asset('images/feature.png') }}" alt="Casita Logo" class="accommodation-logo">
        <ul class="accommodation-list">
          <li><i class="fa-solid fa-building"></i> 65000+ Properties across 640 Cities Globally</li>
           <li><i class="fa-solid fa-tags"></i> Low Price Guarantee</li>
          <li><i class="fa-solid fa-circle-check"></i> Verified Listings</li>
      ...
      <!-- Card 2 -->
      <div class="accommodation-card">
        <img src="{{ asset('images/feature.png') }}" alt="University Living Logo" class="accommodation-logo">
        <ul class="accommodation-list">
        <li><i class="fa-solid fa-building"></i> 65000+ Properties across 640 Cities Globally</li>
        <li><i class="fa-solid fa-shield-halved"></i> Safe & Secure Options</li>
        <li><i class="fa-solid fa-circle-check"></i> Verified Listings</li>
        <li><i class="fa-solid fa-headset"></i> 24/7 Customer Support</li>
        </ul>
        <a href="#" class="btn-primary">Explore Now →</a>
